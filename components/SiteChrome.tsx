...
export function SiteFooter() {
  return <footer className="border-t border-[#1C1E21]/10 bg-white py-14 text-[#1C1E21]"><div className="section-shell grid gap-10 md:grid-cols-[1.2fr_.7fr_.8fr_1.3fr]">
    ...
    <div><p className="text-xs font-semibold uppercase tracking-[.18em] text-[#1877F2]">Contact</p><div className="mt-5 space-y-4 text-sm text-[#1C1E21]/55"><a href="mailto:contact@opusgeeks.com" className="flex gap-3 hover:text-[#1877F2]"><Mail className="h-4 w-4 text-[#1877F2]"/>contact@opusgeeks.com</a><a href="tel:+13466904693" className="flex gap-3 hover:text-[#1877F2]"><Phone className="h-4 w-4 text-[#1877F2]"/>+1 (346) 690-4693</a><a href="https://www.google.com/maps/search/?api=1&query=House+No+B+129+NIPA+Chorangi+near+Imran+Khan+Cricket+Ground+Block+6+Gulshan-e-Iqbal+Karachi+75300+Pakistan" target="_blank" rel="noopener noreferrer" className="group flex gap-3 leading-6 transition hover:text-[#1877F2]"><MapPin className="mt-1 h-4 w-4 shrink-0 text-[#1877F2] transition group-hover:-translate-y-0.5"/><span>House No. B, 129 NIPA Chorangi,<br/>near Imran Khan Cricket Ground,<br/>Block 6 Gulshan-e-Iqbal, Karachi,<br/>75300, Pakistan</span></a><div><p className="mb-3 text-xs font-semibold uppercase tracking-[.16em] text-[#1C1E21]/70">Headquarter</p><a href="https://www.google.com/maps/search/?api=1&query=8903+Pines+Blvd+217+153+Pembroke+Pines+FL+33024+USA" target="_blank" rel="noopener noreferrer" className="group flex gap-3 leading-6 transition hover:text-[#1877F2]"><MapPin className="mt-1 h-4 w-4 shrink-0 text-[#1877F2] transition group-hover:-translate-y-0.5"/><span>8903 Pines Blvd 217 153, Pembroke<br/>Pines, FL 33024, USA</span></a></div></div></div>

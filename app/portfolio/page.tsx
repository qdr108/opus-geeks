...
export default function PortfolioPage() {
  ...
  return (
    <main id="top" className="min-h-screen bg-[#F0F2F5] text-[#1C1E21]">
      ...
      <PortfolioHeader menuOpen={menuOpen} setMenuOpen={setMenuOpen} />
